...
urlpatterns = [
    ...
    path('catalog/', views.CatalogCategoryView.as_view(), name='catalog_category'),
    path('catalog/<slug:slug>/', views.CatalogCategoryDetailView.as_view(), name='catalog_category_detail'),
