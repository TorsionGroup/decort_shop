    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_at', models.DateTimeField(default=datetime.datetime.today, null=True)),
                ('finish_at', models.DateTimeField(default=datetime.datetime.today, null=True)),
            ],
            options={
                'verbose_name': 'Action',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_type', models.CharField(default='1C', max_length=250, null=True)),
                ('gallery_attribute', models.CharField(default='article', max_length=250, null=True)),
                ('gallery_name', models.CharField(blank=True, max_length=250, null=True)),
                ('kind', models.CharField(default='secondary', max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_index', models.IntegerField(blank=True, default=999, null=True)),
                ('content_id', models.IntegerField(blank=True, null=True)),
                ('name', models.CharField(default='Catalog', max_length=500, null=True)),
                ('name_ru', models.CharField(default='Catalog', max_length=500, null=True)),
                ('name_uk', models.CharField(default='Catalog', max_length=500, null=True)),
                ('name_en', models.CharField(default='Catalog', max_length=500, null=True)),
                ...
                ('parent', models.CharField(blank=True, max_length=500, null=True)),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent_id', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='shop.catalogcategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.datetime.today, null=True)),
                ('updated_date', models.DateTimeField(default=datetime.datetime.today, null=True)),
                ...
                ('intro_text_ru', models.CharField(max_length=1000, null=True)),
                ('intro_text_uk', models.CharField(max_length=1000, null=True)),
                ('intro_text_en', models.CharField(max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_eng', models.CharField(blank=True, max_length=250, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region_id', models.CharField(blank=True, max_length=300, null=True)),
                ('source_id', models.CharField(blank=True, max_length=300, null=True)),
                ...
                ('main_customer', models.CharField(blank=True, max_length=300, null=True)),
                ('manager', models.CharField(blank=True, max_length=300, null=True)),
                ('main_customer_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=250, null=True)),
                ('response_date', models.DateTimeField(default=datetime.datetime.today, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_price', models.DecimalField(decimal_places=2, default=0, max_digits=15, null=True)),
                ('is_active', models.BooleanField(default=1, null=True)),
                ('weight', models.DecimalField(decimal_places=3, default=0, max_digits=15)),
                ('pack_qty', models.IntegerField(blank=True, default=0, null=True)),
                ('abc', models.CharField(blank=True, max_length=300, null=True)),
                ...
                ('price_category', models.CharField(blank=True, max_length=300, null=True)),
                ('create_date', models.CharField(blank=True, max_length=300, null=True)),
                ('income_date', models.CharField(blank=True, max_length=300, null=True)),
                ...
                ('price_category_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.pricecategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime.today, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_add', models.DateTimeField(default=datetime.datetime.today, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_request', models.DateTimeField(default=datetime.datetime.today, null=True)),
                ('user_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
